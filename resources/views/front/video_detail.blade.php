                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="post-holder mb40">
                            <div class="post-header">
                                <div class="meta">
                                    <span class="meta-date">{{ $videoDetail->created_at }}</span>
                                    <span class="meta-comments"><a href="#" class="title">Lượt xem: </a>{{ $videoDetail->page_view }}</span>
                                    <span class="meta-category">
                                        <a href="#" class="title">{{ $videoDetail->menu_reference }}</a>
                                    </span>
                                    <span class="meta-user">by <a href="#">admin</a> </span>
                                </div>
                                <h1><a href="/video/chi-tiet/{{ $videoDetail->slug }}" class="title">{{ $videoDetail->title }}</a></h1>
                            </div>
                            <p>{!! $videoDetail->content !!}</p>
                        </div>
                    </div>
                    @endif
                </div>
