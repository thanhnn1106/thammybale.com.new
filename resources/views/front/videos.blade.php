                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="post-holder mb40">
                            <div class="post-img mb30">
                                <a href="/video/chi-tiet/{{ $item->slug }}" class="imghover">
                            ...
                            <div class="post-header">
                                ...
                                <h1><a href="/video/chi-tiet/{{ $item->slug }}" class="title">{{ $item->title }}</a></h1>
                            </div>
                            <a href="/video/chi-tiet/{{ $item->slug }}" class="btn btn-default">Xem</a>
                        </div>
                    </div>
                    @endforeach
                    @endif
